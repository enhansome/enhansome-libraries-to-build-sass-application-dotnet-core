...
* [**Design Patterns for Humans**](https://github.com/kamranahmedse/design-patterns-for-humans) ⭐ 48,873 | 🐛 16 | 📅 2024-12-02
...
* [**Clean Architecture**](https://github.com/jasontaylordev/CleanArchitecture) ⭐ 20,570 | 🐛 20 | 🌐 C# | 📅 2026-09-19 - This is a solution template for creating a Single Page App (SPA) with Angular and ASP.NET Core following the principles of Clean Architecture.
...
* [**OrchardCore**](https://github.com/OrchardCMS/OrchardCore) ⭐ 8,182 | 🐛 850 | 🌐 C# | 📅 2026-09-19 - Orchard Core Framework: An application framework for building modular, multi-tenant applications on ASP.NET Core.
* [**Finbuckle.MultiTenant**](https://github.com/Finbuckle/Finbuckle.MultiTenant) ⭐ 1,622 | 🐛 34 | 🌐 C# | 📅 2026-09-10 - Finbuckle.MultiTenant is a multitenancy library for ASP.NET Core. It provides functionality for tenant resolution, per-tenant app configuration, and per-tenant data isolation.
...
* [**BenchmarkDotNet**](https://github.com/dotnet/BenchmarkDotNet) ⭐ 11,497 | 🐛 165 | 🌐 C# | 📅 2026-09-19 - Powerful .NET library for benchmarking
* [**Serilog**](https://github.com/serilog/serilog) ⭐ 8,038 | 🐛 22 | 🌐 C# | 📅 2026-09-13 - Serilog is a diagnostic logging library for .NET applications. It is easy to set up, has a clean API, and runs on all recent .NET platforms.
* [**NLog**](https://github.com/NLog/NLog) ⭐ 6,545 | 🐛 50 | 🌐 C# | 📅 2026-09-19 -  NLog is a free logging platform for .NET with rich log routing and management capabilities. It makes it easy to produce and manage high-quality logs for your application regardless of its size or complexity.
...
* [**StackExchange.Redis**](https://github.com/StackExchange/StackExchange.Redis) ⭐ 6,200 | 🐛 213 | 🌐 C# | 📅 2026-09-19 -  StackExchange.Redis is a high performance general purpose redis client for .NET languages
...
* [**YARP**](https://github.com/microsoft/reverse-proxy) ⭐ 9,614 | 🐛 193 | 🌐 C# | 📅 2026-09-14 (preview) - A Reverse Proxy by microsoft
...
* [**redoc**](https://github.com/Redocly/redoc) ⭐ 25,915 | 🐛 446 | 🌐 TypeScript | 📅 2026-09-16 - OpenAPI/Swagger-generated API Reference Documentation
...
* [**docsify-dotnet-core**](https://github.com/bharatdwarkani/docsify-dotnet-core) ⭐ 19 | 🐛 0 | 🌐 C# | 📅 2019-10-26 - a sample based on [docsify](https://github.com/docsifyjs/docsify) ⭐ 31,520 | 🐛 93 | 🌐 JavaScript | 📅 2026-09-19 static help document generator based on markdown.

#### Schedulers

* [**Hangfire**](https://github.com/HangfireIO/Hangfire/) ⭐ 10,140 | 🐛 945 | 🌐 C# | 📅 2026-09-18 - Incredibly easy way to perform fire-and-forget, delayed and recurring jobs inside ASP.NET applications.
* [**quartznet**](https://github.com/quartznet/quartznet) ⭐ 7,083 | 🐛 15 | 🌐 C# | 📅 2026-09-19 - Quartz.NET is an opensource project aimed at creating a free-for-commercial use Job Scheduler, with enterprise features.
...
* [**MimeKit**](https://github.com/jstedfast/MimeKit) ⭐ 2,002 | 🐛 13 | 🌐 C# | 📅 2026-09-18 - A .NET MIME creation and parser library with support for S/MIME, PGP, DKIM, TNEF and Unix mbox spools.

#### Unit or Integration Testing

* [**moq**](https://github.com/moq/moq) ⭐ 6,404 | 🐛 22 | 🌐 C# | 📅 2026-09-16 - The most popular and friendly mocking framework for .NET
...
* [**fluentassertions**](https://github.com/fluentassertions/fluentassertions) ⭐ 3,814 | 🐛 66 | 🌐 C# | 📅 2026-09-19 - Fluent API for asserting the results of unit tests that targets
...
* [**Dapper**](https://github.com/StackExchange/Dapper) ⭐ 18,391 | 🐛 551 | 🌐 C# | 📅 2026-09-12 -  a simple object mapper for .Net by Stack Overflow
...
* [**CheatSheetSeries**](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/DotNet_Security_Cheat_Sheet.md) ⭐ 33,225 | 🐛 57 | 🌐 Python | 📅 2026-09-18 - Basic .NET security tips for developers.
...
* [**elsa-core**](https://github.com/elsa-workflows/elsa-core) ⭐ 7,883 | 🐛 772 | 🌐 C# | 📅 2026-09-17 - A .NET Standard 2.0 Workflows Library
...
* [**cake-build**](https://github.com/cake-build/cake) ⭐ 4,191 | 🐛 258 | 🌐 C# | 📅 2026-09-18 - Cake (C# Make) is a cross platform build automation system.
...
* [**nodatime**](https://github.com/nodatime/nodatime) ⭐ 3,002 | 🐛 37 | 🌐 C# | 📅 2026-09-19 - A better date and time API for .NET
...
For more such libraries check out [**awesome-dotnet-core**](https://github.com/thangchung/awesome-dotnet-core) ⭐ 21,386 | 🐛 216 | 🌐 C# | 📅 2026-02-27
